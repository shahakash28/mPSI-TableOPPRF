...
public:
    ...
    void openShare(uint64_t numOfRandomShares, vector<FieldType> &Shares, vector<FieldType> &secrets);
...
*/
  ...
  template <class FieldType>
  void ProtocolParty<FieldType>::openShare(uint64_t numOfRandomShares, vector<FieldType> &Shares, vector<FieldType> &secrets){
      ...
      uint64_t recSize = N * numOfRandomShares * fieldByteSize;
